...
import type { AdvancedFilterBuilderVisibleChangedEvent, AlignedGrid, AlwaysPassFilter, AsyncTransactionsFlushedEvent, AutoGroupColumnDef, AutoSizeStrategy, BatchEditingStartedEvent, BatchEditingStoppedEvent, BodyScrollEndEvent, BodyScrollEvent, BulkEditingStartedEvent, BulkEditingStoppedEvent, CellClickedEvent, CellContextMenuEvent, CellDoubleClickedEvent, CellEditRequestEvent, CellEditingStartedEvent, CellEditingStoppedEvent, CellFocusedEvent, CellKeyDownEvent, CellMouseDownEvent, CellMouseOutEvent, CellMouseOverEvent, CellSelectionChangedEvent, CellSelectionDeleteEndEvent, CellSelectionDeleteStartEvent, CellSelectionOptions, CellValueChangedEvent, ChartCreatedEvent, ChartDestroyedEvent, ChartOptionsChangedEvent, ChartRangeSelectionChangedEvent, ChartToolPanelsDef, ColDef, ColGroupDef, ColTypeDefs, ColumnEverythingChangedEvent, ColumnGroupOpenedEvent, ColumnHeaderClickedEvent, ColumnHeaderContextMenuEvent, ColumnHeaderMouseLeaveEvent, ColumnHeaderMouseOverEvent, ColumnMenuVisibleChangedEvent, ColumnMovedEvent, ColumnPinnedEvent, ColumnPivotChangedEvent, ColumnPivotModeChangedEvent, ColumnResizedEvent, ColumnRowGroupChangedEvent, ColumnValueChangedEvent, ColumnVisibleEvent, ColumnsResetEvent, ComponentStateChangedEvent, Components, ContextMenuVisibleChangedEvent, CreateChartContainer, CsvExportParams, CustomChartThemes, CutEndEvent, CutStartEvent, DataTypeDefinitions, DefaultChartMenuItem, DisplayedColumnsChangedEvent, DoesExternalFilterPass, DomLayoutType, DragCancelledEvent, DragStartedEvent, DragStoppedEvent, EditStrategyType, EditValidationCommitType, ExcelExportParams, ExcelStyle, ExpandOrCollapseAllEvent, FillEndEvent, FillOperation, FillStartEvent, FilterChangedEvent, FilterHandlers, FilterModifiedEvent, FilterOpenedEvent, FilterUiChangedEvent, FindChangedEvent, FindOptions, FirstDataRenderedEvent, FloatingFilterUiChangedEvent, FocusGridInnerElement, FormulaDataSource, FormulaFuncs, FullWidthCellKeyDownEvent, GetBusinessKeyForNode, GetChartMenuItems, GetChartToolbarItems, GetChildCount, GetContextMenuItems, GetDataPath, GetDocument, GetFullRowEditValidationErrors, GetGroupRowAgg, GetLocaleText, GetMainMenuItems, GetRowClass, GetRowHeight, GetRowIdFunc, GetRowStyle, GetServerSideGroupKey, GetServerSideGroupLevelParams, GridColumnsChangedEvent, GridReadyEvent, GridSizeChangedEvent, GridState, GroupHierarchyConfig, HeaderFocusedEvent, IAdvancedFilterBuilderParams, IAdvancedFilterParams, IAggFuncs, IDatasource, IServerSideDatasource, IViewportDatasource, Icons, InitialGroupOrderComparator, IsApplyServerSideTransaction, IsExternalFilterPresent, IsFullWidthRow, IsGroupOpenByDefault, IsRowFilterable, IsRowMaster, IsRowPinnable, IsRowPinned, IsRowSelectable, IsRowValidDropPositionCallback, IsServerSideGroup, IsServerSideGroupOpenByDefault, LoadingCellRendererSelectorFunc, LocaleText, MenuItemDef, ModelUpdatedEvent, NavigateToNextCell, NavigateToNextHeader, NewColumnsLoadedEvent, OverlaySelectorFunc, OverlayType, PaginationChangedEvent, PaginationNumberFormatter, PasteEndEvent, PasteStartEvent, PinnedRowDataChangedEvent, PinnedRowsChangedEvent, PivotMaxColumnsExceededEvent, PostProcessPopup, PostSortRows, ProcessCellForClipboard, ProcessCellFromClipboard, ProcessDataFromClipboard, ProcessGroupHeaderForClipboard, ProcessHeaderForClipboard, ProcessPivotResultColDef, ProcessPivotResultColGroupDef, ProcessRowPostCreate, ProcessUnpinnedColumns, QuickFilterMatcher, QuickFilterParser, RangeDeleteEndEvent, RangeDeleteStartEvent, RangeSelectionChangedEvent, RedoEndedEvent, RedoStartedEvent, RowClassRules, RowClickedEvent, RowDataUpdatedEvent, RowDoubleClickedEvent, RowDragCancelEvent, RowDragEndEvent, RowDragEnterEvent, RowDragLeaveEvent, RowDragMoveEvent, RowDragTextFunc, RowEditingStartedEvent, RowEditingStoppedEvent, RowGroupOpenedEvent, RowGroupingDisplayType, RowModelType, RowNumbersOptions, RowResizeEndedEvent, RowResizeStartedEvent, RowSelectedEvent, RowSelectionOptions, RowStyle, RowValueChangedEvent, SelectionChangedEvent, SelectionColumnDef, SendToClipboard, SideBarDef, SortChangedEvent, SortDirection, StateUpdatedEvent, StatusBar, StoreRefreshedEvent, TabToNextCell, TabToNextGridContainer, TabToNextHeader, Theme, ToolPanelSizeChangedEvent, ToolPanelVisibleChangedEvent, TooltipHideEvent, TooltipShowEvent, TreeDataDisplayType, UndoEndedEvent, UndoStartedEvent, UseGroupTotalRow, ViewportChangedEvent, VirtualColumnsChangedEvent, VirtualRowRemovedEvent } from 'ag-grid-community';
...
export declare class AgGridAngular<TData = any, TColDef extends ColDef<TData> = ColDef<any>> implements AfterViewInit, OnChanges, OnDestroy {
     ...
     * @agModule `TooltipModule`
     */
    tooltipSwitchShowDelay: number | undefined;
     ...
     * @agModule `QuickFilterModule`
     */
    quickFilterParser: QuickFilterParser | undefined;
    /** Changes the matching logic for whether a row passes the Quick Filter.
     * @agModule `QuickFilterModule`
     */
    quickFilterMatcher: QuickFilterMatcher | undefined;
     ...
     */
    alwaysPassFilter: AlwaysPassFilter<TData> | undefined;
     ...
     * @initial
     */
    filterHandlers: FilterHandlers<TData> | undefined;
     ...
     * @agModule `IntegratedChartsModule`
     */
    customChartThemes: CustomChartThemes | undefined;
     ...
     */
    suppressOverlays: OverlayType[] | undefined;
     ...
     * @initial
     */
    overlayComponentSelector: OverlaySelectorFunc<TData> | undefined;
     ...
     * @agModule `RowGroupingModule` / `PivotModule` / `TreeDataModule` / `ServerSideRowModelModule`
     */
    aggFuncs: IAggFuncs<TData> | undefined;
     ...
     * @agModule `RowDragModule`
     */
    rowDragText: RowDragTextFunc | undefined;
     ...
     * @agModule `RowGroupingModule` / `TreeDataModule`
     */
    autoGroupColumnDef: AutoGroupColumnDef<TData> | undefined;
     ...
     * @agModule `RowGroupingModule`
     */
    groupHideColumnsUntilExpanded: boolean | undefined;
     ...
     * @agModule `RowGroupingModule`
     */
    groupHierarchyConfig: GroupHierarchyConfig | undefined;
     ...
     */
    postProcessPopup: PostProcessPopup<TData> | undefined;
     ...
     * @initial
     */
    processUnpinnedColumns: ProcessUnpinnedColumns<TData> | undefined;
    /** Allows you to process cells for the clipboard. Handy if for example you have `Date` objects that need to have a particular format if importing into Excel.
     * @agModule `ClipboardModule`
     */
    processCellForClipboard: ProcessCellForClipboard<TData> | undefined;
    /** Allows you to process header values for the clipboard.
     * @agModule `ClipboardModule`
     */
    processHeaderForClipboard: ProcessHeaderForClipboard<TData> | undefined;
    /** Allows you to process group header values for the clipboard.
     * @agModule `ClipboardModule`
     */
    processGroupHeaderForClipboard: ProcessGroupHeaderForClipboard<TData> | undefined;
    /** Allows you to process cells from the clipboard. Handy if for example you have number fields and want to block non-numbers from getting into the grid.
     * @agModule `ClipboardModule`
     */
    processCellFromClipboard: ProcessCellFromClipboard<TData> | undefined;
    /** Allows you to get the data that would otherwise go to the clipboard. To be used when you want to control the 'copy to clipboard' operation yourself.
     * @agModule `ClipboardModule`
     */
    sendToClipboard: SendToClipboard<TData> | undefined;
    /** Allows complete control of the paste operation, including cancelling the operation (so nothing happens) or replacing the data with other data.
     * @agModule `ClipboardModule`
     */
    processDataFromClipboard: ProcessDataFromClipboard<TData> | undefined;
    /** Grid calls this method to know if an external filter is present.
     * @agModule `ExternalFilterModule`
     */
    isExternalFilterPresent: IsExternalFilterPresent<TData> | undefined;
    /** Should return `true` if external filter passes, otherwise `false`.
     * @agModule `ExternalFilterModule`
     */
    doesExternalFilterPass: DoesExternalFilterPass<TData> | undefined;
     ...
     * @agModule `IntegratedChartsModule`
     */
    createChartContainer: CreateChartContainer<TData> | undefined;
     ...
     */
    focusGridInnerElement: FocusGridInnerElement<TData> | undefined;
    /** Allows overriding the default behaviour for when user hits navigation (arrow) key when a header is focused. Return the next Header position to navigate to or `null` to stay on current header.
     */
    navigateToNextHeader: NavigateToNextHeader<TData> | undefined;
     ...
     */
    tabToNextHeader: TabToNextHeader<TData> | undefined;
    /** Allows overriding the default behaviour for when user hits navigation (arrow) key when a cell is focused. Return the next Cell position to navigate to or `null` to stay on current cell.
     */
    navigateToNextCell: NavigateToNextCell<TData> | undefined;
    /** Allows overriding the default behaviour for when user hits `Tab` key when a cell is focused.
     * Return the next cell position to navigate to, `true` to stay on the current cell,
     * or `false` to let the browser handle the tab behaviour.
     */
    tabToNextCell: TabToNextCell<TData> | undefined;
     ...
     */
    tabToNextGridContainer: TabToNextGridContainer<TData> | undefined;
    /** A callback for localising text within the grid.
     * @initial
     * @agModule `LocaleModule`
     */
    getLocaleText: GetLocaleText<TData> | undefined;
    /** Allows overriding what `document` is used. Currently used by Drag and Drop (may extend to other places in the future). Use this when you want the grid to use a different `document` than the one available on the global scope. This can happen if docking out components (something which Electron supports)
     */
    getDocument: GetDocument | undefined;
    /** Allows user to format the numbers in the pagination panel, i.e. 'row count' and 'page number' labels. This is for pagination panel only, to format numbers inside the grid's cells (i.e. your data), then use `valueFormatter` in the column definitions.
     * @initial
     * @agModule `PaginationModule`
     */
    paginationNumberFormatter: PaginationNumberFormatter<TData> | undefined;
    /** Callback to use when you need access to more then the current column for aggregation.
     * @agModule `RowGroupingModule` / `PivotModule` / `TreeDataModule` / `ServerSideRowModelModule`
     */
    getGroupRowAgg: GetGroupRowAgg<TData> | undefined;
    /** (Client-side Row Model only) Allows groups to be open by default.
     * @agModule `RowGroupingModule` / `TreeDataModule`
     */
    isGroupOpenByDefault: IsGroupOpenByDefault<TData> | undefined;
     ...
     * @agModule `RowGroupingModule`
     */
    initialGroupOrderComparator: InitialGroupOrderComparator<TData> | undefined;
    /** Callback for the mutation of the generated pivot result column definitions
     * @agModule `PivotModule`
     */
    processPivotResultColDef: ProcessPivotResultColDef<TData> | undefined;
    /** Callback for the mutation of the generated pivot result column group definitions
     * @agModule `PivotModule`
     */
    processPivotResultColGroupDef: ProcessPivotResultColGroupDef<TData> | undefined;
     ...
     * @agModule `ServerSideRowModelModule`
     */
    getChildCount: GetChildCount | undefined;
    /** Allows providing different params for different levels of grouping.
     * @initial
     * @agModule `ServerSideRowModelModule`
     */
    getServerSideGroupLevelParams: GetServerSideGroupLevelParams<TData> | undefined;
    /** Allows groups to be open by default.
     * @agModule `ServerSideRowModelModule`
     */
    isServerSideGroupOpenByDefault: IsServerSideGroupOpenByDefault<TData> | undefined;
     ...
     */
    getBusinessKeyForNode: GetBusinessKeyForNode<TData> | undefined;
     ...
     */
    processRowPostCreate: ProcessRowPostCreate<TData> | undefined;
     ...
     */
    fillOperation: FillOperation<TData> | undefined;
    /** Callback to perform additional sorting after the grid has sorted the rows.
     */
    postSortRows: PostSortRows<TData> | undefined;
    /** Callback version of property `rowStyle` to set style for each row individually. Function should return an object of CSS values or undefined for no styles.
     * @agModule `RowStyleModule`
     */
    getRowStyle: GetRowStyle<TData> | undefined;
    /** Callback version of property `rowClass` to set class(es) for each row individually. Function should return either a string (class name), array of strings (array of class names) or undefined for no class.
     * @agModule `RowStyleModule`
     */
    getRowClass: GetRowClass<TData> | undefined;
    /** Callback version of property `rowHeight` to set height for each row individually. Function should return a positive number of pixels, or return `null`/`undefined` to use the default row height.
     */
    getRowHeight: GetRowHeight<TData> | undefined;
    /** Tells the grid if this row should be rendered as full width.
     */
    isFullWidthRow: IsFullWidthRow<TData> | undefined;
     ...
     */
    columnsReset: EventEmitter<ColumnsResetEvent<TData>>;
     ...
     */
    bulkEditingStarted: EventEmitter<BulkEditingStartedEvent<TData>>;
    /** Bulk editing has stopped.
     */
    bulkEditingStopped: EventEmitter<BulkEditingStoppedEvent<TData>>;
     ...
     */
    batchEditingStarted: EventEmitter<BatchEditingStartedEvent<TData>>;
     ...
     */
    batchEditingStopped: EventEmitter<BatchEditingStoppedEvent<TData>>;
     ...
     */
    filterUiChanged: EventEmitter<FilterUiChangedEvent<TData>>;
    /** Floating filter UI modified (when using `enableFilterHandlers = true`).
     */
    floatingFilterUiChanged: EventEmitter<FloatingFilterUiChangedEvent<TData>>;
     ...
     */
    rowResizeStarted: EventEmitter<RowResizeStartedEvent<TData>>;
    /** The row resize has ended (Row Numbers Feature)
     */
    rowResizeEnded: EventEmitter<RowResizeEndedEvent<TData>>;
     ...
     */
    pinnedRowsChanged: EventEmitter<PinnedRowsChangedEvent<TData>>;
    ...
    static ngAcceptInputType_hidePaddedHeaderRows: unknown;
    ...
    static ngAcceptInputType_animateColumnResizing: unknown;
    static ngAcceptInputType_suppressStartEditOnTab: unknown;
    ...
    static ngAcceptInputType_enableFilterHandlers: unknown;
    ...
    static ngAcceptInputType_refreshAfterGroupEdit: unknown;
    ...
    static ngAcceptInputType_groupHideColumnsUntilExpanded: unknown;
    ...
    static ngAcceptInputType_ssrmExpandAllAffectsAllRows: unknown;
